[SIPHRO-FINAL-SHEETS (2).html](https://github.com/user-attachments/files/25351548/SIPHRO-FINAL-SHEETS.2.html)
<!DOCTYPE html>
<html lang="fr">
<head>
<meta charset="UTF-8">
...
async function loadData(){
  ...
  try {
    ...
    setSyncStatus('❌ Erreur CORS — voir instructions','#dc2626');
    showNotif('⚠️ Erreur : ' + e.message + ' — Vérifiez le déploiement Apps Script','error');
    prospects = [];
  }
  renderAll();
...
function formatTel(raw){
  if(!raw||raw==="-"||raw==="-"||raw.trim()==="")return raw||"";
